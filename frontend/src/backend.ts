...
import type { MusicEntry as _MusicEntry, StreamingPlatform as _StreamingPlatform, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addMusicEntry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string | null, arg6: Array<StreamingPlatform>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMusicEntry(arg0, arg1, arg2, arg3, arg4, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteMusicEntry(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteMusicEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllEntries(): Promise<Array<MusicEntry>> {
        if (this.processError) {
            try {
    ...
    async getIdEntry(arg0: bigint): Promise<MusicEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getIdEntry(arg0);
                return from_candid_MusicEntry_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async searchEntries(arg0: string): Promise<Array<MusicEntry>> {
        if (this.processError) {
            try {
    ...
    async updateMusicEntry(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string | null, arg7: Array<StreamingPlatform>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMusicEntry(arg0, arg1, arg2, arg3, arg4, arg5, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg6), arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MusicEntry_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MusicEntry): MusicEntry {
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        genre: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.genre)),
        artist: value.artist,
...
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MusicEntry>): Array<MusicEntry> {
    return value.map((x)=>from_candid_MusicEntry_n5(_uploadFile, _downloadFile, x));
}
